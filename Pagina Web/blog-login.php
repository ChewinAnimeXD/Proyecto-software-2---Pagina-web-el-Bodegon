	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
		      ...
		      <li class="nav-item"><a href="contact.html" class="nav-link">Inicio de sesion</a></li>
	        </ul>
	      </div>
		  </div>
	  </nav>
		...
		<div class="row justify-content-center">
			<div class="col-11">
				...
				<?php 
				    ...
				    while ($comentario = mysqli_fetch_object($resultado))
					{
				        ...
				        <b><?php echo($comentario->nombre); ?></b> (<?php echo($comentario->fecha); ?> dijo: <br />
			...
			<div class="col-11 text-center">
				...
				<form id="formulario" action="enviarcomentario.php" method="post">
				    ...
				    <h3>Nombre:</h3>
					<input type="text" name="nombre" id="nombre" placeholder="Escriba aqui su nombre"/>
					<br /><br />
					<h3>Cometario:</h3>
