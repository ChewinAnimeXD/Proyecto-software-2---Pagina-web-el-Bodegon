            ...
            <div id="layoutSidenav_content" >
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Sistema de Reservación de un establecimiento</h1>
                 ...
                 <div class="container-fluid col-sm-6 col-md-8" >
				    ...
				    <form action="" method="POST" class="formulario">
							<a><center><h2>Formulario de reservación de establecimiento</h2></center></a>
						...
						<div class="col_one_third col_last c-azul">
                                    ...
                                    <input type="date" min='2022-11-18' id="nacimiento"  name="fecha"  class="sm-form-control">
                                </div>


						<?php
                            include("conexionR.php");
                            include("controlador_reserva_local.php");
                        ?>

                             <div class="form-group mt-4 mb-0"><input class="btn btn-primary btn-block" type="submit" value="Realizar Reservación del establecimiento" name="Registro"></a></div>
                    </form>
	            </div>                        
